...
// status_since = momento exacto en que el pedido entró a en_reparto (migration 014)
  ...
  return (
    <div className="space-y-4">
        ...
        <div className="relative px-6 py-5 flex items-center justify-between gap-4 flex-wrap">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-white font-semibold">En reparto ahora</p>
          ...
          <div className="flex items-center gap-4 shrink-0">
            {entregadosSesionCount > 0 && (
              <span className="text-sm text-green-200 font-semibold">
                ✓ {entregadosSesionCount} entregado{entregadosSesionCount !== 1 ? 's' : ''} hoy y ayer
              </span>
            )}
      ...
      <div className="space-y-2">
        ...
        {/* Fila 2: chips informativos desde API */}
      ...
      {(loading || allOrders.length > 0 || allEntregados.length > 0) && (
        <div className="bg-white rounded-xl border-2 border-amber-200 overflow-hidden shadow-sm">
          ...
          <div className="px-4 py-3 border-b border-amber-100 bg-white">
            <div className="relative max-w-lg">
              ...
              <input
                ...
                placeholder="Buscar por guía, nombre, teléfono, ciudad o courier…"
          ...
          {!loading && totalPages > 1 && (
            <div className="flex items-center justify-between px-5 py-3 border-t border-amber-100 bg-amber-50/40">
              <button
      ...
      {!loading && inTransitOrders.length > 0 && (
        <div className="flex items-center justify-between gap-3 bg-blue-50 border border-blue-200 rounded-xl px-5 py-3">
          <div className="flex items-center gap-3 flex-wrap">
            <div className="flex items-center gap-1.5">
