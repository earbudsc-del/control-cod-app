...
//   + dosIntentos==0 ? 8 : max(0, 8−dosIntentos×2) → max 8 pts (sin críticos)
//   − min(novedadesVencidas×2, 20)  → max −20 pts penalización
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
      <div className="flex items-center gap-3 px-5 py-3.5 bg-gray-50 border-b border-gray-100">
        ...
        <h2 className="text-sm font-bold text-gray-800">Breakdown auditable</h2>
        <span className="ml-auto text-xs text-gray-500">{breakdown.length} casos · RD${totalPago.toLocaleString()} total</span>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-4">
        ...
        <div className="bg-white rounded-2xl border-2 border-green-300 p-6 flex flex-col items-center justify-center gap-4 shadow-sm">
          ...
          <p className="text-xs text-gray-500 text-center leading-relaxed">
            Calculado sobre {data.metrics.trabajadosSemana ?? 0} casos trabajados en los últimos 30 días
          </p>
          <div className="flex flex-col gap-1.5 w-full text-[11px] text-gray-500">
            <div className="flex justify-between"><span>Novedad resuelta (entregado):</span><span className="font-bold text-green-600">+RD$25</span></div>
            <div className="flex justify-between"><span>Recuperado + entregado:</span><span className="font-bold text-teal-600">+RD$35</span></div>
            <div className="flex justify-between"><span>2+ intentos trabajados:</span><span className="font-bold text-amber-600">+RD$10</span></div>
            <div className="flex justify-between"><span>Devuelto (trabajado):</span><span className="font-bold text-gray-600">+RD$5</span></div>
          </div>
